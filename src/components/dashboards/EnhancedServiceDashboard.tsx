...
export function EnhancedServiceDashboard({ userRole }: ServiceDashboardProps) {
  ...
  const renderCustomerDashboard = () => (
    <CorporateLayout
      ...
      subtitle="Welcome to Industrial Customer Service. Get support, track your equipment, and manage service requests."
      headerActions={
      ...
      <TabsContent value="parts" className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground mb-4">Browse and order genuine industrial parts</p>
              <Button 
                className="w-full"
