...
export function EquipmentCatalogModule() {
  ...
  const catalogItems = [
    { id: "CAT-001", partNumber: "GT-45001", name: "Engine Oil Filter", category: "Filters", price: 450, stock: 150, supplier: "Industrial Parts" },
    { id: "CAT-002", partNumber: "GT-45002", name: "Air Filter Assembly", category: "Filters", price: 680, stock: 89, supplier: "Industrial Parts" },
