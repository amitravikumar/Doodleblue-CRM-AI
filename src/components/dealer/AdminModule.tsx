...
export function AdminModule() {
  const [activeTab, setActiveTab] = useState("service-care");
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Manage Service Care programs and system administration</p>
      </div>

      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-4">
          <TabsTrigger value="service-care" className="flex items-center gap-2">
        ...
        <TabsContent value="service-care" className="mt-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input id="company-name" defaultValue="Industrial Solutions Ltd" />
                </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input id="support-email" defaultValue="support@industrialsolutions.com" />
                </div>
                ...
                <div>
                  ...
                  <Textarea id="address" defaultValue="Industrial Solutions Limited, Mumbai, Maharashtra, India" />
                </div>
