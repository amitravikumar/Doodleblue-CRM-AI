...
export function CustomerTicketOptions({ isOpen, onClose }: CustomerTicketOptionsProps) {
  ...
  const handleContactMethod = (methodId: string) => {
    ...
    switch (methodId) {
      case "whatsapp":
        window.open("https://wa.me/919876543210?text=Hello, I need technical support for my industrial equipment.", "_blank");
        break;
      case "call":
        window.open("tel:+919876543210", "_self");
        break;
      case "email":
        window.open("mailto:support@industrial.com?subject=Technical Support Request&body=Dear Support Team,%0A%0AI need assistance with my industrial equipment.%0A%0AEquipment Details:%0A- Model: %0A- Serial Number: %0A- Issue Description: %0A%0AThank you.", "_self");
        break;
    }
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <p className="text-muted-foreground">
              Choose the best way to get technical support for your industrial equipment
            </p>
          </DialogHeader>
