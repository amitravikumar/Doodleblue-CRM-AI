  ...
  const mockParts: Part[] = [
    {
      ...
      rating: 4.5,
      reviews: 128,
      description: "High-performance oil filter for industrial generators. Ensures optimal engine performance.",
    ...
    },
    {
      ...
      rating: 4.8,
      reviews: 67,
      description: "Original fuel pump assembly with electronic control.",
      image: "/placeholder.svg",
      specifications: {
        "Voltage": "12V DC",
        "Pressure": "3.5 bar",
